...
function Valider() {
    revenus = Number(document.querySelector("#revenus").value)
    nbAdulte = Number(document.querySelector("#nbAdulte").value)
    nbEnfants = Number(document.querySelector("#nbEnfants").value)
